...
export async function toHaveComputedLabel(received, label, options = {}) {
    ...
    const message = enhanceError(el, wrapExpectedWithArray(el, actualLabel, label), actualLabel, this, verb, expectation, '', options);
    return {
        pass,
        message: () => message,
    };
